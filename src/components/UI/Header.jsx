  ...
  return (
    <div>
      ...
      <div className='flex flex-row justify-around my-2 py-2 border-y-2 border-slate-600'>
          <div className='py-2 mx-4'><Link to='/projects'><h5 className='text-lg'><HomeWorkIcon /> PROJECTS</h5></Link></div>
          <div className='py-2 mx-4'><Link to='/productlibrary'><h5 className='text-lg'><MenuBookIcon /> PRODUCT LIBRARY</h5></Link></div>
